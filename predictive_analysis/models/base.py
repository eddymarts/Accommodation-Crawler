...
class BaseModel:
    ...
    def tune(self):
        ...
        self.tune_time = tuning_end - tuning_start
        self.best_model = grid_search.best_estimator_
        self.best_hyperparameters = grid_search.best_params_
        self.fitting_time = grid_search.refit_time_
        self.results = grid_search.cv_results_['params'][grid_search.best_index_]
        self.results['score'] = grid_search.best_score_
        self.results['fit_time'] = grid_search.refit_time_
        self.results['tune_time'] = self.tune_time
